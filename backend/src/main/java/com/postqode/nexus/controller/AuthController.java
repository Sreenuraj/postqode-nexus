...
public class AuthController {
        ...
        @ApiResponses(value = {
                        ...
                        @ApiResponse(responseCode = "400", description = "Invalid input or username taken", content = @Content)
        })
        ...
        @Operation(summary = "User login", description = "Authenticate user and receive JWT token. Use credentials: admin/Admin@123 or user/User@123")
        @ApiResponses(value = {
        ...
        @Operation(summary = "User logout", description = "Logout current user (client should discard JWT token)", security = @SecurityRequirement(name = "bearerAuth"))
        @ApiResponses(value = {
        ...
        @Operation(summary = "Get current user", description = "Get information about the currently authenticated user", security = @SecurityRequirement(name = "bearerAuth"))
        @ApiResponses(value = {
