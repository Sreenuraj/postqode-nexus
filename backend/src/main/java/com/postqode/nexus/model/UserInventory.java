...
public class UserInventory {
    ...
    @Column(columnDefinition = "inventory_source", nullable = false)
    ...
    public UserInventory(User user, Product product, String name, Integer quantity, InventorySource source,
            String notes) {
        this.user = user;
